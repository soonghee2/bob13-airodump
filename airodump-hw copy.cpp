...
int main(int argc, char *argv[]) {
    ...
    while (true) {
        ...
        // Determine if it is a beacon or data frame
        if (fc->type == 0 && fc->subtype == 8) { // Beacon frame
            ...
            // Extract signal strength (power)
            beacon_packet.power = (int8_t)packet[22]; // Example signal strength
            ...
            if (rsn_info) {
                ...
                if (strstr((const char *)rsn_info, "\x31")) { // Check for WPA3 identifier
